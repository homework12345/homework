...
<html>
  ...
  <body>
    ...
    <main>
	    <s:form action="write/write_queryAllWrite" method="post">
	      
	      <div>
	         <s:submit value="查询" cssClass="search-go"></s:submit>
	         <input class="search" type="text" name="book.bookname" placeholder="请输入关键词">
	      </div>
	        ...
	        <tr>  
	         ...
	         <s:iterator value="writeList" status="status">
	          <tr>
	            ...
	            <td><s:a href="write/write_showDetail?write.writeid=%{writeid}"><s:property value="book.bookname"></s:property></s:a></td>
